...
fname='NSE2022/test_0526_2236.csv'
...
def true_sphere_parameter():
    parameter_file=open("NSE2022/parameter/"+"test_0526_2236.csv")
...
x0,y0,z0,sx,sy,sz,P=true_sphere_parameter()
